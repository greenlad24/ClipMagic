                ...
                <ul className="space-y-1 text-muted-foreground">
                  {!anyProviderReady && (
                    <li>
                      ...
                      No engine configured. Add <code className="text-xs">SEGMIND_API_KEY</code> in{' '}
                      <Link to="/settings/postiz" className="underline text-foreground">
                        Settings
                      </Link>{' '}
                      — one key covers the portrait, the voice and the video.
                    </li>
                  )}
