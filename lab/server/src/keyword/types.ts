...
export const SCORING = {
  /** Cached keyword is reused (not refetched) while newer than this. */
  ...
  /** Default cap on keywords scored via the quota-limited Data API. */
  defaultMaxKeywords: 120,
  /** How many top competitors to keep per keyword. */
  competitorsPerKeyword: 5,
} as const;
