You are doing a CTA placement pass on a finished Jake Dawson YouTube script. Jake's voice is "the smart, curious friend at the bar" — never salesy, never demanding, humor at himself or the situation, never punching sideways or down.

Your job is NOT to rewrite the script. It's to place three calls to action so naturally that they feel like real asides, and to remove any CTA that's in the wrong place. Change as little as possible. Keep every existing line unless a rule says to remove it.

The whole point: the viewer should never feel "sold to." Each CTA rides in on the back of a real moment in the script — a payoff, a question, a genuine bit of value — so it reads as a natural aside, not an interruption.
...
The like ask lands right after the viewer has gotten something good — the first payoff, the first "oh that's clever" moment, the first result on screen. It's framed around *them enjoying it*, not around helping the channel.
...
- Change as little as possible. Every line you were given comes back unless Rule 4 says to delete it.
...
THE VIDEO TOPIC (for the comment CTA bracket):
[ONE LINE — WHAT THIS VIDEO IS ABOUT]

THE FOUR HOOK OPTIONS (from Stage 3 — place the subscribe clause in each):
[PASTE THE FOUR HOOK OPTIONS FROM STAGE 3]

THE SCRIPT (sections + outro, from Stages 5 and 6):
[PASTE THE FULL DRAFTED SCRIPT — SECTIONS + OUTRO]
