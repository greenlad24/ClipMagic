...
The outline:
[PASTE THE SECTION YOU'RE WORKING ON]

---

CORE STYLE: Kevin Stratvert's Direct Approach + Jake's bar-Jake voice
...
JAKE'S SIGNATURE ELEMENTS:

Problem framing — describe the situation, never accuse the viewer:
- ✅ "You've got a calendar, a CRM, a form tool, and they barely speak to each other."
...
STRUCTURAL CONVERSATIONAL POINTS (MKBHD-style — positive with a sparkle of realism)
...
- "There's some other [X]…"
- "But then last but not least…"

▶ Slot 3 — REAL-TIME THINKING (the "bar friend" texture)
Tiny words that signal a real person, not a teleprompter. Spread across the whole script.
- "Like…" (mid-thought)
- "So…" (mid-thought reset)
- "I mean…"
- "You know…"
...
- "I I don't quite trust [X] yet to…"
- "I guess I shouldn't go too hard on this just yet."
...
- "So, it can already, you know, do [baseline]…"
- "But let's say you're [specific situation]…"
- "Well, if you have [X], it can actually…"
- "…without you having to [the manual pain]."
...
Benefit reveals (specific, not hyped):
...
SENTENCE STRUCTURE:
- One full thought per sentence
- 10–15 words average
- Every sentence must stand alone
- No tongue twisters, no stacked ideas
- Use everyday words — would you say this to a friend at lunch?

❌ BAD: "This optimizes your creative workflow with parallel image generation."
✅ GOOD: "You can make four images at the same time."

---

WORD SWAPS (use the everyday word):
...
| game-changer | (describe what it does) |
...
REVIEW STEP (built into Stage 5):
After ChatGPT writes a section, paste it back with this instruction:
...
Iterate until the section passes.

---

CHECKLIST PER SECTION:
✅ Does every sentence stand alone?
✅ Would Jake say this at the bar to a stranger he liked?
✅ Could a 14-year-old follow it?
...
ONLY use information from the outline provided.
