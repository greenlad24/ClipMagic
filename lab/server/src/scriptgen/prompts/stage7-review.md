...
- **No banned word survives, in any form.** "caveat"/"caveats" (say "one thing to know" or "the catch"), "clever", "genuinely", "real deal", "which" (split the sentence or use "that"), "whether" (say "if"). Singular or plural, they get rewritten — not softened, removed. Also "Picture …" as an opener (Jake says "Imagine …"). (Rule 8.)
