...
function reviewGuardBlock(ledger: ContinuityLedger, hasFactSheet: boolean): string {
  ...
  lines.push(
    ...
    "",
    "Banned words — rewrite any of these out of this section: \"caveat\" (say \"the catch is\"), \"clever\" (say what it does), \"neat\" (say what it does for the viewer), \"which\" (split the sentence or use \"that\"), \"whether\" (say \"if\"). Say \"Imagine …\" never \"Picture …\". And never a bare clipped question like \"No door?\" — lead with the little word a person would say: \"And if there's no door?\"",
    "",
